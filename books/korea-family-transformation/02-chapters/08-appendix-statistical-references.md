...
The following figure slots are part of the production plan. Replace each slot with a licensed archival image, an original chart generated from the cited dataset, or a commissioned conceptual illustration. Do not leave the bracketed production notes visible in the reader-facing PDF.
...
3 | Institutional timeline | Chapter 2, full width | Colonial legal and Korean historical sources

4 | Gendered economy diagram | Chapter 2, half page | Labor-history sources

5 | Registration architecture | Chapter 3, full page | Civil Act and Family Relations Registration Act

6 | Legal reform timeline | Chapter 3, one-third page | Constitutional Court, NHRC, KLRI

7 | Female labor-force participation | Chapter 4, full width | Statistics Korea/OECD, matching definitions

8 | Unpaid work and care time | Chapter 4, half page | Statistics Korea Time Use Survey

9 | TFR and marriage timing | Chapter 5, full width | Statistics Korea vital and marriage statistics

10 | One-person households by age | Chapter 5, half page | Population and Housing Census
